...
def scatter_points_europe(gdf: geopandas.GeoDataFrame,
    ...
    ax.set(xlabel='longitude', ylabel='latitude', fontsize=23)
    #if plot_colorbar:
    divider = make_axes_locatable(ax)
    cax = divider.append_axes("right", size="5%", pad=0.1)
    #aspect='1.3',
...
ax.set_title('Mean air pressure at mean sea level 24 hours before a Dunkelflaute [hPa]',fontsize=26)
ax.xticks(fontsize=23)
ax.yticks(fontsize=23)
ax = axes[1]
scatter_points_europe(DF_Data, 'msl_DE', ax=ax, cmap='magma')
ax.set_title('Mean air pressure at mean sea level during a Dunkelflaute [hPa]', fontsize=26)
ax.xticks(fontsize=23)
ax.yticks(fontsize=23)
ax = axes[2]
scatter_points_europe(DF_Data_ref, 'msl_DE', ax=ax, cmap='magma')
ax.set_title('Mean air pressure at mean sea level during a reference period [hPa]', fontsize=26)
ax.xticks(fontsize=23)
ax.yticks(fontsize=23)
fig.tight_layout()
...
ax.set_title('Mean temperature at 2 meters 24 hours before a Dunkelflaute [$^\circ$C]',fontsize=26)
ax.xticks(fontsize=23)
ax.yticks(fontsize=23)
ax = axes[1]
scatter_points_europe(DF_Data, 't2m_DE', ax=ax, cmap='magma')
ax.set_title('Mean temperature at 2 meters during a Dunkelflaute [$^\circ$C]', fontsize=26)
ax.xticks(fontsize=23)
ax.yticks(fontsize=23)
ax = axes[2]
scatter_points_europe(DF_Data_ref, 't2m_DE', ax=ax, cmap='magma')
ax.set_title('Mean temperature at 2 meters a during reference period [$^\circ$C]', fontsize=26)
ax.xticks(fontsize=23)
ax.yticks(fontsize=23)
fig.tight_layout()
...
ax.set_title('Mean solar radiation at the surface 24 hours before a Dunkelflaute [W m $^{-2}$]',fontsize=26)
ax.xticks(fontsize=23)
ax.yticks(fontsize=23)
ax = axes[1]
scatter_points_europe(DF_Data, 'ssrdDE', ax=ax, cmap='magma')
ax.set_title('Mean solar radiation at the surface during a Dunkelflaute [W m $^{-2}$]', fontsize=26)
ax.xticks(fontsize=23)
ax.yticks(fontsize=23)
ax = axes[2]
scatter_points_europe(DF_Data_ref, 'ssrdDE', ax=ax, cmap='magma')
ax.set_title('Mean solar radiation at the surface during reference period [W m $^{-2}$]', fontsize=26)
ax.xticks(fontsize=23)
ax.yticks(fontsize=23)
fig.tight_layout()
...
ax.set_title('Mean wind speed at 10 meters 24 hours before a Dunkelflaute [$m/s$]',fontsize=26)
ax.xticks(fontsize=23)
ax.yticks(fontsize=23)
ax = axes[1]
scatter_points_europe(DF_Data, 'DF_Data_all_mean_ws10DE', ax=ax, cmap='magma')
ax.set_title('Mean wind speed at 10 meters during a Dunkelflaute [$m/s$]', fontsize=26)
ax.xticks(fontsize=23)
ax.yticks(fontsize=23)
ax = axes[2]
scatter_points_europe(DF_Data_ref, 'DF_Data_all_mean_ws10DE', ax=ax, cmap='magma')
ax.set_title('Mean wind speed at 10 meters during reference period [$m/s$]', fontsize=26)
ax.xticks(fontsize=23)
ax.yticks(fontsize=23)
fig.tight_layout()
...
ax.set_title('Mean wind speed at 100 meters 24 hours before a Dunkelflaute [$m/s$]',fontsize=26)
ax.xticks(fontsize=23)
ax.yticks(fontsize=23)
ax = axes[1]
scatter_points_europe(DF_Data, 'var_100_metre_wind_speedDE', ax=ax, cmap='magma')
ax.set_title('Mean wind speed at 100 meters during a Dunkelflaute [$m/s$]', fontsize=26)
ax.xticks(fontsize=23)
ax.yticks(fontsize=23)
ax = axes[2]
scatter_points_europe(DF_Data_ref, 'var_100_metre_wind_speedDE', ax=ax, cmap='magma')
ax.set_title('Mean wind speed at 100 meters during reference period [$m/s$]', fontsize=26)
ax.xticks(fontsize=23)
ax.yticks(fontsize=23)
fig.tight_layout()
